...
export class ProfileService {
  ...
  getPersonalInfo(): PersonalInfo {
    return {
      name: 'Nitin Wadavale',
      title: 'Tech Lead',
      tagline: 'Tech Lead | 7+ Years | Angular · Ionic · Flutter UI',
      summary: 'Results-driven and innovative Web Developer with over 7+ years of expertise in leading cross-functional teams to deliver high-impact web solutions. Proven track record of successfully managing the entire development lifecycle, from conceptualization to deployment, while ensuring adherence to best practices and industry standards.',
      dob: '08 June 1993',
      address: '503, Kuber Sambruddi, Dombivli West',
      city: 'Dombivli',
      state: 'Maharashtra',
      pincode: '421402',
      phone: '+91 7977518951',
      email: 'nwadavale08@gmail.com',
      linkedin: 'https://linkedin.com/in/nitin-wadavale',
      instagram: 'https://instagram.com/nitin_wadavale',
